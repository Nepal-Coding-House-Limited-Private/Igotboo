        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              >
                <h2 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent">
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-rose-100"
              >
                <h2 className="text-2xl font-semibold mb-6 bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent">
                  Dating Tips
                </h2>
                <ul className="space-y-4 text-gray-600">
                  <motion.li whileHover={{ x: 10 }} className="flex items-center gap-2 transition-all duration-300">
