...
const Messages = () => {
  ...
  return (
    <div className="h-full flex">
      {/* Contacts List */}
      <div className="w-1/3 border-r bg-gray-50 flex flex-col min-w-0">
        <div className="p-4 border-b bg-white">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50"
            />
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 border-b bg-white">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 flex-shrink-0">
              <button className="text-gray-500 hover:text-red-500 p-2 hover:bg-gray-100 rounded-full">
                <Phone size={20} />
              </button>
              <button className="text-gray-500 hover:text-red-500 p-2 hover:bg-gray-100 rounded-full">
                <Video size={20} />
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
          <div className="max-w-full">
            {messages.map((message) => (
              <div
                key={message.id}
                className={`flex items-start space-x-2 ${message.isSent ? 'justify-end' : ''}`}
              >
                {!message.isSent && (
        ...
        <div className="p-4 border-t bg-white">
          <form onSubmit={handleSendMessage}>
            <div className="flex items-center space-x-4">
              <button type="button" className="text-gray-500 hover:text-red-500 p-2 hover:bg-gray-100 rounded-full flex-shrink-0">
                <Paperclip size={20} />
              </button>
              <input
                type="text"
                ...
                className="flex-1 border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50 min-w-0"
              />
              <button type="button" className="text-gray-500 hover:text-red-500 p-2 hover:bg-gray-100 rounded-full flex-shrink-0">
                <Smile size={20} />
              </button>
